label q5_8a:
    ...
    n "คำตอบผมทำให้เอมิหัวเราะร่วนในลำคอเบาๆ" with dissolve
    hide laught
    ei "รุ่นพี่นี่ปากไม่ตรงกับใจนะคะ "
    tk "ทำไมเธอถึงสรุปไปทางนั้นล่ะ?"
    hide Eimi02_date_body_Eimi02_smug2

    show Eimi02_date_body_Eimi02_smug3
    ei "ไม่ใช่ว่าแอบเล็งเอมิไว้เหรอคะ เลยพามาเลี้ยงร้านอาหารแพงๆเนี่ย " with dissolve
    tk "เล็ง?"
    n "ผมเอียงคองงกับคำพูดของเด็กสาวผมน้ำตาล เธอเลยทำปากยื่นๆใส่ผมแล้วทำแก้มป่องราวกับกำลังงอนใส่ผมไม่มีผิด"
    hide Eimi02_date_body_Eimi02_smug3

    show Eimi02_date_body_Eimi02_pout
    show pout with Dissolve(1.0)
    ei "ก็หมายความว่ารุ่นพี่กำลังแอบจีบหนูไงคะ บู่วๆ " with dissolve
    hide pout
    tk "....."
    n "ผมเผลอมองบนกับคำตอบของเอมิ ทำให้เอมิสะดุ้งเฮือกกับการกระทำที่ถากถางเธอโดยไม่ต้องเปล่งเสียงใดๆ"
    hide Eimi02_date_body_Eimi02_pout

    show Eimi02_date_body_Eimi02_panic
    show panic with Dissolve(1.0)
    ei "รุ่นพี่อย่าทำสายตาแบบนั้นใส่หนูสิค้า " with dissolve
    hide panic
    tk "ฉันไม่ได้ทำหน้าอะไรแบบนั้นสักหน่อย"
    hide Eimi02_date_body_Eimi02_panic

    show Eimi02_date_body_Eimi02_fuyukai
    ei "ความรู้สึกเบื่อโลกมันออกมาทางสีหน้าอย่างชัดเจนเลยค่ะ " with dissolve
    tk "....."
    hide Eimi02_date_body_Eimi02_fuyukai

    show Eimi02_date_body_Eimi02_meme02
    show down with Dissolve(1.0)
    ei "ทำแบบนี้ เอมิก็เสียใจเป็นนะคะ ซิก " with dissolve
    hide down
    n "เอมิทำตาหมองๆใส่ผม พร้อมกับทำก้มหัวลงเหมือนกำลังซึม "
    "หารู้ไม่ว่าผมรู้ไต๋ยัยนี่ดี มุกยัยนี่ก็วนอยู่ไม่กี่แบบแหละ"
    ...
    hide pout
    tk "ขอโทษละกันที่พูดได้แต่อะไรแนวๆนี้"
    ...
    "เทียบกับคนอื่นๆ ผมว่าผมเห็นใจเอมิง่ายเป็นพิเศษ"
    "ทำไมกัน?"
    "นั่นสิ...ทำไมกันนะ? "
