...
for c in onlyfiles:
    ...
    print("    "+"zoom 0.75")
    print('    im.Composite((1920,2900), (0,1500), "Sprite/Eimi01/Eimi02_Body.png" ,(0,1500),"Sprite/Eimi02/'+c+"\")")

for c in onlyfiles:
    print("image" + " " + "Eimi02_shy_"+c.split('.')[0]+":")
    print("    "+"zoom 0.75")
    print('    im.Composite((1920,2900), (0,1500), "Sprite/Eimi01/Eimi02_Body_shy.png" ,(0,1500),"Sprite/Eimi02/'+c+"\")")
