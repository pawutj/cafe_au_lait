label q5_9:
    ...
    tk "ถ้าฉันตอบว่ามันน่ารัก เธอจะหาว่าฉันหลงตัวเองเพราะฉันชมสัตว์ที่เหมือนตัวเอง ถ้าฉันบอกว่ามันน่าเกลียด เธอจะหาว่าฉันกำลังด่าตัวเองเพราะฉลามมันเหมือนฉัน "
    ei "อุหวา"
    tk "ฉันเดามุกเธอถูกใช่ไหม? เอมิ"
    n "เอมิทำตาโตอ้าปากค้างไปแล้ว ในขณะที่ผมลองเชิงเธอด้วยคำถาม"
    "ไม่นานหลังจากนั้น เด็กสาวผมน้ำตาลก็ทำแก้มป่องๆใส่ผมแทน"
    ei "ทำไมจู่ๆรุ่นพี่ถึงหัวไวขึ้นมาล่ะคะ ร้ายกาจจริงๆค่ะ"
    tk "ฉันไม่ได้หัวไวขึ้น แค่อยู่กับเธอนานๆแล้วเข้าใจเธอง่ายขึ้นน่ะ"
    ei "หวาว รุ่นพี่เข้าใจเอมิงั้นเหรอคะ? "
    tk "....."
    ...
    n "คำพูดจากเอมิทำให้ผมชำเลืองมองเธอด้วยสายตาคมๆ ทำให้เอมิหัวเราะกลบเกลื่อนใส่ผม"
    hide Eimi02_date_body_Eimi02_wink

    show Eimi02_date_body_Eimi02_smile3
    show laught with Dissolve(1.0)
    ei "แฮะๆๆ ล้อเล่นค่ะๆ" with dissolve
    hide laught
    tk "ถ้าจะชอบมัน ฉันก็คงชอบนิสัยของมัน"
    hide Eimi02_date_body_Eimi02_smile3

    show Eimi02_date_body_Eimi02_0
    ei "นิสัยเหรอคะ?" with dissolve
    tk "ฉลามน่ะขึ้นชื่อว่าเป็นสัตว์ที่ไม่ถอยจากการต่อสู้ง่ายๆ"
    hide Eimi02_date_body_Eimi02_0

    show Eimi02_date_body_Eimi02_normal
    ei "....." with dissolve
    tk "ทั้งความมุ่งมั่น ทั้งความแข็งแกร่งและความไม่ยอมแพ้ เธอไม่คิดว่ามันเป็นสิ่งที่ดีงั้นเหรอ เอมิ?"
    n "เอมิเลิกคิ้วขึ้นน้อยๆหลังจากเธอฟังผม "
    ...
    hide laught
    n "เอมิส่งเสียงหัวเราะกังวานใส ผมที่เห็นใบหน้าสดใสของเธอก็เผลอยิ้มออกมา"
    tk "คนเราน่ะไม่ได้เก่งขึ้นง่ายอย่างงั้นหรอกนะ เอมิ"
    n "พวกเราสองคนต่างถือตุ๊กตาฉลามไว้ในมือ"
    stop music
    "สำหรับผมกับเธอที่ไล่ตามเป้าหมายและมีแต่ต้องมุ่งไปข้างหน้า คงไม่มีของฝากคู่กันอันไหนที่เหมาะกว่านี้ไปอีกแล้ว"
    ...
    show Eimi02_date_body_Eimi02_smile3
    ei "รุ่นพี่คิดว่ายังไงบ้างล่ะคะ?" with dissolve
    tk "ยังไง?"
    n "ผมทวนคำพูดเอมิด้วยความสงสัย ส่วนเอมิส่งยิ้มให้ผมด้วยความเป็นมิตร"
    hide Eimi02_date_body_Eimi02_smile3

    show Eimi02_date_body_Eimi02_smile2
    show laught with Dissolve(1.0)
    ei "รุ่นพี่ก็สนุกใช่ไหมคะ ฮะๆๆ" with dissolve
    hide laught
    n "เด็กสาวเรือนผมสีน้ำตาลหัวเราะเสียงกังวานใส เธอเต็มไปด้วยรอยยิ้มและมีฉากหลังเป็นท้องฟ้าสีส้มที่มีพระอาทิตย์ใกล้ตกดินเป็นภาพที่น่าดูชม"
    "ผมยกมุมปากขึ้นน้อยๆ"
    tk "ก็สนุกดีนะ"
    ...
    show Eimi02_date_body_Eimi02_0
    ei "....." with dissolve
    n "เอมิทำตาโตขึ้นกว่าเดิม เธอสบมองเข้ามาในดวงตาผมด้วยความประหลาดใจ"
    tk "ทำหน้าแบบนั้นทำไมล่ะ?"
    hide Eimi02_date_body_Eimi02_0

    show Eimi02_date_body_Eimi02_smile2
    ei "เอมิแค่ไม่นึกว่ารุ่นพี่จะพูดอะไรตรงๆออกมาค่ะ" with dissolve
    tk "เหรอ"
    hide Eimi02_date_body_Eimi02_smile2

    show Eimi02_date_body_Eimi02_smile
    ei "รุ่นพี่ทาคากิเปิดใจกับหนูมากกว่าเดิมนะคะ หนูรู้สึกได้" with dissolve
    n "เอมิส่งยิ้มกว้างให้ผม "
    tk "ฉันว่าฉันก็ไม่ได้เปลี่ยนไปขนาดนั้นนะ"
    hide Eimi02_date_body_Eimi02_smile

    show Eimi02_date_body_Eimi02_smile3
    ei "เอมิว่ารุ่นพี่ยิ้มเก่งขึ้นเยอะนะคะ" with dissolve
    tk "ขนาดนั้นเลยเหรอ?"
    n "เด็กสาวผมสีน้ำตาลพยักหน้าให้ผมด้วยความมั่นใจ"
    hide Eimi02_date_body_Eimi02_smile3

    show Eimi02_date_body_Eimi02_smile
    ei "รุ่นพี่ตอนนี้ดูน่ากลัวน้อยกว่ารุ่นพี่ที่เจอกันครั้งแรกมากเลยค่ะ " with dissolve
    tk "....."
    n "ผมไม่ได้พูดอะไรออกไป เพียงแค่รับคำชมของเธอเงียบๆเท่านั้น ความรู้สึกอบอุ่นที่ก่อตัวข้างในอกทำให้ผมรู้สึกประดักประเดิดจนไม่กล้าพูดกับเธอ"
    "น่าแปลกจริงๆ"
    hide Eimi02_date_body_Eimi02_smile

    show Eimi02_date_body_Eimi02_smug
    voice "audio/voice/5_00.mp3"
    ei "ไหนๆก็จะบอกลากันแล้ว เอมิมีอะไรจะให้ค่ะ" with dissolve
    tk "ให้อะไร?"
    n "ผมถามเอมิด้วยความสงสัยแต่เธอกลับยิ้มเจ้าเล่ห์ใส่ผมแทนก่อนที่จะชี้นิ้วไปทางๆหนึ่งแล้วพูดขึ้น"
    hide Eimi02_date_body_Eimi02_smug

    show Eimi02_date_body_Eimi02_smile3
    voice "audio/voice/5_01.mp3"
    ei "มองไปทางนั้นค่ะ " with dissolve
    tk "หา?"
    n "ผมอุทานขึ้นด้วยความไม่เข้าใจ แต่ก็ยอมทำตามเอมิแต่โดยดี "
    "ผมเดาไม่ออกหรอกว่ายัยนี่จะให้ของขวัญหรือจะแกล้งอะไรผมหรือเปล่า แต่ในเมื่อเธอกำลังอารมณ์ดี ผมเลยยอมฟังเธอเพราะว่าไม่อยากให้เธอหม่นหมองลง"
    ...
    "ที่มาของสัมผัสอันเบาบางนั้นคือริมฝีปากของเอมิที่ประทับลงบนแก้มผม "
    "กลิ่นหอมๆจากเรือนกายเด็กสาวผมน้ำตาล รวมถึงเสียงลมหายใจที่ไล้เลียข้างหูผม ประกอบกับใบหน้าน่าเอ็นดูของเอมิที่เปื้อนสีแดงระเรื่อทำให้ผมรู้สึกว่าหัวใจตัวเองเต้นแรงขึ้น"
    "สัมผัสที่อ่อนหวานค่อยๆจางหายลงเมื่อเอมิเลื่อนร่างห่างออกไปทีละน้อย"
    "เด็กสาวผมน้ำตาลยิ้มให้ผม รอยยิ้มที่แสนสวยงามราวกับภาพวาด"
    voice "audio/voice/5_02.mp3"
